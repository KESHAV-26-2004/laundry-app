...
class DryCleanOrdersPage extends StatefulWidget {
  const DryCleanOrdersPage({super.key});

  @override
  State<DryCleanOrdersPage> createState() => _DryCleanOrdersPageState();
}

class _DryCleanOrdersPageState extends State<DryCleanOrdersPage> {
  ...
  Future<void> _updateOrderStatus(String orderId, String currentStatus) async {
    ...
    if (newStatus.isNotEmpty) {
      await FirebaseFirestore.instance.collection('dryCleanOrders').doc(orderId).update({
        'status': newStatus,
      });
      _fetchOrders();
    }
          ...
          Expanded(
            child: _filteredOrders.isEmpty
              ...
              itemBuilder: (context, index) {
                ...
                final bool showAcceptButton = (status == 'Order Placed') ||
                    (status == 'Completed' &&
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8.0),
                        Text('Total Amount: $totalAmount', style: const TextStyle(fontSize: 16)),
                        const SizedBox(height: 8.0),
