  ...
  Future<void> _createUser() async {
    try {
      ...
      if (_role == 'student') {
        ...
        userData['enrollment'] = enrollment.toUpperCase();
      }

      await userCredential.user!.sendEmailVerification();//verification email
      ...
      await FirebaseAuth.instance.signOut(); // Sign out new user

    // Replace with your admin login again (either hardcoded or saved securely)
