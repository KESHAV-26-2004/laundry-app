...
import 'stud_notifications.dart';
...
class _StudentScaffoldState extends State<StudentScaffold> {
  int unreadCount = 0;
  bool _isNotificationCanvasVisible = false;
  ...
  /*void _fetchUnreadNotifications() {
    ...
    FirebaseFirestore.instance
        ...
        .listen((snapshot) {
      if (snapshot.exists) {
        final List notifications = snapshot.get('messages') ?? [];
        final int count =
  ...
  void _toggleNotificationCanvas() {
    setState(() {
      _isNotificationCanvasVisible = !_isNotificationCanvasVisible;
    });
  }
          ...
          AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: _toggleNotificationCanvas,
              ),
            ],
          ),
      drawer: Drawer(
